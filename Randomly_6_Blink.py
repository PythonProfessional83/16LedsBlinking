# Randomly_6_Blink
'''
Module for 6 leds blinking randomly from 16 available leds.
'''
import random
import time
    ...
    try:
        while True:
            ...
            if (inde_x1 != inde_x2 and inde_x1 != inde_x3 and inde_x2 != inde_x3
                ...
                and inde_x1 != inde_x6 and inde_x2 != inde_x6 and inde_x3 != inde_x6 and inde_x4 != inde_x6 and inde_x5 != inde_x6):
            ...
            GPIO.setup((pin1, pin2, pin3, pin4, pin5, pin6), GPIO.OUT)

            # led on
            GPIO.output((pin1, pin2, pin3, pin4, pin5, pin6), GPIO.HIGH)
            time.sleep(tim_e)
            # led off
            GPIO.output((pin1, pin2, pin3, pin4, pin5, pin6), GPIO.LOW)
            time.sleep(tim_e)
